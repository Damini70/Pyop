...
const VendorSignup = ({setKey,showDialog=false,profile={},setOpenEdit,getProfile}) => {
  ...
  const handleSubmit = async (e) => {
   ...
   if(showDialog){
    const profileRes=await makeRequest("put",`vendor/update-vendor-profile?vendorId=${profile._id}`,vendorData);
  ...
  return (
    <div className={`${!showDialog?"vendor-signup-wrapper":""} w-75`}>
      ...
      {!showDialog&&  <div className="form-group">
     ...
     {!showDialog&&   <div className="form-group">
       ...
       {showDialog?
                 <div className="flex justify-between mt-3">
                   <Button className="pyop-button" onClick={()=>setOpenEdit(false)}>Cancel</Button>
